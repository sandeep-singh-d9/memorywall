...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2['default'].fn.cropit = function (method) {
	  ...
	  } else if (['imageState', 'imageSrc', 'offset', 'previewSize', 'imageSize', 'zoom', 'initialZoom', 'exportZoom', 'minZoom', 'maxZoom','rotationWidth'].indexOf(method) >= 0) {
	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function loadImage(imageSrc) {
		  ...
		  console.log(imageSrc , '12121211212')
	    ...
	    value: function onImageLoaded() {
	      ...
	      if (this.options.imageState && this.options.imageState.offset) {
			...
			console.log(this.offset, '19393838')
	      } else {
	        this.centerImage();
	      }
	    ...
	    value: function onPreviewEvent(e) {
		  ...
		  console.log(this.$imageContainer, 'on mouse')
		...
		//   console.log(this.moveContinue && eventPosition, '777')
	    ...
	    value: function fixOffset(offset) {
	      ...
	      if (!this.options.freeMove) {
			  console.log(this.imageWidth * this.zoom >= this.previewSize.width, 'true')
	    ...
	    value: function renderImage() {
			// console.log(this.rotatedOffset, 'asasasas')
	    ...
	    key: 'rotationWidth',
	    set: function (newRotation) {
			this._rotationWidth = newRotation;
			console.log(this._rotationWidth, '11')
