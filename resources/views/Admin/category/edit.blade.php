        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    {!! Form::model($categoryData, ['route' => ['category.update', $categoryData->id], 'method' =>
                    'put', 'name' => 'frm_category', 'id' => 'frm_category', 'files' => true]) !!}
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                <div class="form-line">
                                    ...
                                    __('language.select').' '.__('language.status')]) !!}
                                </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <img src="{{$categoryData->category_image}}" id="preview1" width="" height="60px">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-primary btn_save">@lang('language.update')</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
                </div>
