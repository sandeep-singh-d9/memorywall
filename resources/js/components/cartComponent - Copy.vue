<template>
	<div>
		...
		<div class="builder container right_div padding_70" >
			<div class="row m-0">
				<div class="col-lg-12 p-0 canvas_inner" v-show="this.allCartValueStore.length > 0">
					<h2 class="text-uppercase Vogue header_title">Shopping Cart</h2>
					<div class="row m-0 mt-5">
						<div class="col-md-8 cart_left">
							<div v-for="(data, index) in this.allCartValueStore" :key="index">
								...
								<div class="table-responsive">
									<table class="table table-borderless mb-0">
										...
										<tr v-if="showDiscount">
											<td>Discount</td>
											<td class="font_bold text-center"><i class="fas fa-rupee-sign"></i> -{{ discount }} </td>
										</tr>
										<tr>
				...
				<!-- cart empty -->
				<div class="col-lg-12 p-0 canvas_inner text-center" v-if="this.allCartValueStore.length == 0">
...
import {
	...
	data() {
		return {
			...
			shippingCharge : 0,
			GST : 0,
			allCartValue : this.allCartValueStore,
			cartIndex : '',
			quantityValue: [],
			cartLength:0,
			promocode: '',
