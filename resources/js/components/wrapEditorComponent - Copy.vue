            ...
            <div class="row m-0">
                <div class="col-lg-6 p-5 mt-3 mirrored">
                    <div class="innner_previewimg" id="wrappedEdge" :style="{paddingLeft: '13px' , paddingTop: thickDimension !== '' ? '0px' : '10px'}">
                        <div class="wrapped_edge" :style="{height: '420px', width: '420px'}">
                            ...
                            <div class="image__preview wrapper" :style="{height: thickDimension !== '' ? boxHeight+20+'px' : dynamicHeight, width: thickDimension !== '' ? boxWidth+20+'px' : dynamicWidth, marginLeft: thickDimension !== '' ? '-10px' : '0px' }">
                                <span class="tleft_corner preview-line" :style="{top: '-0.5px',zIndex: '99999',left: thickDimension !== '' ? '-10px' : '0px', width:thickDimension !== '' ? '30px' : '20px', height:thickDimension !== '' ? '30px' : '20px'}">
                                    <p class="topdotted" :style="{width: boxWidth-40+'px',height: thickDimension !== '' ? '30px' : '20px',marginLeft: thickDimension !== '' ? '30px' : '20px'}"></p>
                                    <p class="bbottompdotted" :style="{width: boxWidth-40+'px',height:thickDimension !== '' ? '30px' : '20px',marginLeft: thickDimension !== '' ? '30px' : '20px', top: thickDimension !== '' ? boxHeight-10+'px' : boxHeight-20+'px'}"></p>
                                    <p class="bleftdotted" :style="{width: thickDimension !== '' ? '30px' : '20px',height:boxHeight-40+'px',marginTop: thickDimension !== '' ? '30px' : '20px'}"></p>
                                </span>
                                <span class="tright_corner preview-line" :style="{top:'-0.5px',zIndex: '99999',left:boxWidth-20+'px', width:thickDimension !== '' ? '30px' : '20px', height:thickDimension !== '' ? '30px' : '20px'}">
                                    <p class="toprightdotted" :style="{width:thickDimension !== '' ? '30px' : '20px',height:boxHeight-40+'px',marginTop: thickDimension !== '' ? '30px' : '20px'}"></p>
                                </span>
                                <span class="bbottom_corner preview-line" :style="{top:thickDimension !== '' ? boxHeight-10+'px' : boxHeight-20+'px',zIndex: '99999',left:boxWidth-20+'px', width:thickDimension !== '' ? '30px' : '20px', height:thickDimension !== '' ? '30px' : '20px'}"> </span>
                                <span class="bleft_corner preview-line" :style="{left:thickDimension !== '' ? '-10.5px' : '-0.5px',zIndex: '99999',top:thickDimension !== '' ? boxHeight-10+'px' : boxHeight-20+'px', width:thickDimension !== '' ? '30px' : '20px', height:thickDimension !== '' ? '30px' : '20px'}"> </span>
                ...
                <div class="col-lg-6 pl-3 canvas_inner">
                    ...
                    <div class="float-left col-md-12 px-4 pb-3 bottom_circles">
                        <h2 class="poppins"><i class="fas fa-rupee-sign"></i>{{dynamicPrice}}</h2>
...
export default {
    ...
    methods:{
        ...
        zoomChange(){
            ...
            let scale = (this.zoomValue*5)+420
        ...
        layoutModify(){
            ...
            if(this.selectedCanvasWidth ==  this.selectedCanvasHeight){
                ...
                console.log(this.selectedCanvasWidth, this.selectedCanvasHeight, 'asasas')
                this.dynamicWidth = '420px'
        ...
        storeToCart(){
            console.log(this.cartIndex, 'sasa')
            if (this.cartIndex != '') {
        ...
        changeRoute(value){
            ...
            if(value ==  'mirror'){
                console.log(this.canvasType, 'sasassasaasasasasa')
    ...
    watch:{
        canvasType(value){
            if(value  == 'gallerywrap1'){
                ...
                console.log(this.heightZoomed, 'sasa')
            }else{
                this.thickDimension = ''
                console.log(this.heightZoomed, 'sasa')
