                            ...
                            <div class="image__preview_section"  :style="{paddingLeft:'0px', width: thickDimension !== '' ? topWrapWidth+60+'px' :topWrapWidth+40+'px', position:'relative' , top:thickDimension !== '' ? '0px' : ''}">
                                ...
                                <div class="image__preview_top" :style="{height: thickDimension !== '' ? thickDimension+'px' :'20px', width:dynamicWidth, opacity:canvasType != 'roleCanvas' ? '1': '0', marginLeft:thickDimension !== '' ? '30px' :'20px'}">
                                    <div class="innerimage_window" :style="{width: '100%', height: 'auto',  paddingTop:dynamicHeight}">
                                        <div class="innerimage_canvas" :style="{ backgroundColor: imageType == 'color' ?  color : '', left: '0px', top:'0' }">
                                            <img class="image__preview_image transform-after-drag" :src="imagePath"  v-if="imageType != 'color'"  :style="{width:WidthZoomed == '' ? imageWidth : WidthZoomed, height: heightZoomed == '' ?imageHeight : heightZoomed, transform: 'translate3d(-94.8576px, 0px, 0px) scale('+this.zoomValue+') rotate(0deg) !important'}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="image__preview_right" :style="{height: dynamicHeight, width: thickDimension !== '' ? thickDimension+'px' :'20px', opacity:canvasType != 'roleCanvas' ? '1': '0' ,left: thickDimension !== '' ? topWrapWidth+30+'px' : '0' , position: thickDimension !== ''?'absolute' : ''}">
                                    <div class="innerimage_window" :style="{height: dynamicHeight, width: dynamicWidth, paddingTop:dynamicHeight}">
                                        <div class="innerimage_canvas" :style="{ backgroundColor: imageType == 'color' ?  color : '' , top: '0px', right:'0', left:'auto' }">
                                            <img class="image__preview_image transform-after-drag" :src="imagePath"  v-if="imageType != 'color'"  :style="{marginLeft: '0px', width:WidthZoomed == '' ? imageWidth : WidthZoomed, height:heightZoomed == '' ? imageHeight : heightZoomed, transform: 'translate3d(-94.8576px, 0px, 0px) scale('+this.zoomValue+') rotate(0deg) !important'}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="image__preview wrapper" id="prviewSelected"  :class="{'borderdotted': canvasType == 'roleCanvas'}"  :style="{width:dynamicWidth,height:dynamicHeight,marginLeft:thickDimension !== '' ? '30px' :'20px' }">
                                    <div class="innerimage_window" :style="{width: '100%', height: 'auto' ,paddingTop:dynamicHeight, cursor:'all-scroll'}">
                                        <div  class="innerimage_canvas" style="top:0; left:0" :style="{cursor:imagePath == '' ?'pointer' : ''}" @click="uploadImageFilestack" @mouseleave="mouseleave($event)">
                                            <img class="image__preview_main transform-after-drag  trigger map" :src="imagePath" :style="{width:imageWidth, height: imageHeight, transform: 'translate3d(-94.8576px, 0px, 0px) scale('+this.zoomValue+') rotate(0deg) !important'}" id="main_image">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="image__preview_bottom-inner">
                                        <div class="innerimage_window" :style="{width:'100%', height:'auto',  paddingTop:bottomImageHeight-5+'px'}">
                                            <div class="innerimage_canvas" :style="{ backgroundColor: imageType == 'color' ?  color : '', top:'0px', left:'0'}">
                                                <img  class="image__preview_image transform-after-drag" :src="imagePath"  v-if="imageType != 'color'"  :style="{marginTop: '0px', width:WidthZoomed == '' ? imageWidth: WidthZoomed, height:heightZoomed == '' ? imageHeight : heightZoomed, transform: 'translate3d(-94.8576px, 0px, 0px) scale('+this.zoomValue+') rotate(0deg) !important'}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    methods:{
        ...
        imageUpload(){
            ...
            function updateForm(result){
                ...
                console.log(dynamicStyle, 'style')
